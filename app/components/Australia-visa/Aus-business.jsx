...
const Ausbusiness = () => {
  return (
    <div className="m-2 p-2" style={{
      ...
      <div className="mb-6">
        <h4 className="mb-6"><b>Key Types of Australia Business Visas</b></h4>

        <p>1. <b>Business Innovation and Investment (Provisional) Visa (subclass 188)</b> The Subclass 188 visa is ideal for individuals looking to manage or invest in a business in Australia. It is a temporary visa with pathways to permanent residency. The visa has several streams:</p>
        <ul className='ml-8 list-disc mb-6'>
          <li><b>Business Innovation Stream:</b> For those with a successful business background who wish to own and manage a business in Australia.</li>
          <li><b>Investor Stream:</b> For individuals willing to invest at least AUD 2.5 million in Australian state or territory government bonds.</li>
          <li><b>Significant Investor Stream:</b> For high-net-worth individuals ready to invest AUD 5 million into complying investments in Australia.</li>
          <li><b>Entrepreneur Stream:</b> For those who have a viable business idea and are supported by a state or territory government to start a business in Australia.</li>
        </ul>

        <p className="mb-6"><b>2. Business Talent (Permanent) Visa (subclass 132)</b> This permanent visa is designed for business owners and entrepreneurs with significant business experience and a proven track record of success. It allows individuals to establish or manage a business in Australia with the potential for long-term growth. To be eligible, applicants need to be nominated by a state or territory government and meet certain financial thresholds.</p>
      ...
      <div className="mb-6">
        ...
        <h4 className="mb-6"><b>Eligibility Criteria for the Australia Business Visa</b></h4>

        <p className="mb-6">While the exact eligibility requirements vary depending on the specific visa subclass, common criteria include:</p>

        <ul className='ml-8 mb-6 list-disc'>
          <li><b>• Business Experience:</b> Depending on the visa stream, applicants may need to demonstrate a history of successful business ownership or management.</li>
          <li><b>• Investment Capital:</b> For some visa types, there are minimum investment thresholds that must be met, such as investing AUD 1 million or more in Australia.</li>
          <li><b>• Nomination:</b> Some business visas require applicants to be nominated by an Australian state or territory government.</li>
          <li><b>• English Language Proficiency:</b> Some applicants may need to meet a certain level of English language ability.</li>
          <li><b>• Health and Character Requirements:</b> Applicants must pass medical and character checks as part of the visa application process.</li>
        </ul>

        <h4 className='mb-6'><b>Application Process</b></h4>

        <p className="mb-6">The process for applying for an Australian Business Visa can be complex, with various steps depending on the specific visa subclass. The general steps include:</p>

        <ol className='ml-24 mb-6'>
          <li><b>1. Expression of Interest (EOI):</b> Submit an EOI to indicate your interest in applying for a business visa.</li>
          <li><b>2. State Nomination:</b> For certain visa subclasses, you must be nominated by a state or territory government.</li>
          <li><b>3. Visa Application:</b> Submit your visa application once you meet all requirements and have been nominated.</li>
          <li><b>4. Visa Decision:</b> Wait for a decision from the Department of Home Affairs regarding your application.</li>
        </ol>

        <h4 className="mb-6"><b>Why Choose VJC Overseas for Your Business Visa?</b></h4>
        ...
        <p>This content highlights the key aspects of the Australia Business Visa in a detailed and informative manner, helping prospective applicants understand their options and the application process. If you need more tailored advice or specific assistance, we at VJC Overseas are here to guide you toward a successful future in Australia.</p>
      </div>
    </div>
  );
}
