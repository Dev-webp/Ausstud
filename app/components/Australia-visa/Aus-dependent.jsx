...
const Ausdependent = () => {
  return (
    <div className="m-2 p-2" style={{
      ...
      <h4 className="mb-6"><b>Eligibility Criteria</b></h4>

      <p className="mb-6">To qualify for an Australian Dependent Visa, the applicant must meet certain criteria:</p>
      ...
      <ul className='ml-6 mb-6'>
        ...
        <li><b>• Financial Support: </b>The primary visa holder must demonstrate they can financially support their dependents while living in Australia.</li>
      ...
      <h4 className="mb-6"><b>The Application Process</b></h4>

      <p className="mb-6">Applying for an Australian Dependent Visa involves several steps:</p>
